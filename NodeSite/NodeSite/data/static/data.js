...
'use strict';
var SearchChart, chart, data, dataPkgForD3, drawLine, drawLineChart, drawLineWithFocusChart, duration, generateData, getData, getDataFromS, redraw, renderRTChart, requestData;
...
dataPkgForD3 = function(data) {
  var key, sensor, sensorType, v, values, _i, _j, _len, _len1, _sensors, _values;
  _sensors = {};
  ...
  SearchChart.prototype.submit = function(e) {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        for (key in datapkg) {
          data = datapkg[key];
          html = '<div id="search-' + key + '-chart" class="chart">\n  <svg></svg>\n</div>';
