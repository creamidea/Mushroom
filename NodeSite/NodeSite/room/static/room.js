...
'use strict';
var $averages, AverageUI, Room, RoomList, RoomPresenter, Test, context, render, renderRoom, renderRoomList, renderRoomMeta, renderSensorsList, renderStatic, sensorEnToCn, test;
...
Test = (function() {
  ...
  Test.prototype.update = function(age) {
    return this.trigger("update", age);
  };
...
test.on("update", function(age) {
  return console.log("update age: ", age);
});
