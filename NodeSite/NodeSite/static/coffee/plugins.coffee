...
(->
    ...
    console = (window.console = window.console || {author: "icecream"});
...
# ==============================================================
  ...
  #     #   @html = template(context)
  #     # catch e
  #     #   partialName = e.message.split(' ')[2] #The name of the partial template
  #     #   partialHtml = $("##{partialName}").html()
  #     #   console.log partialName, partialHtml
  #     #   if partialHtml
  #     #     Handlebars.registerPartial(partialName, partialHtml)
  #     #     template = Handlebars.compile(source)
  #     #     @html = template(context)
  #     #   else                    #说明不是the partial找不到
  #     #     throw e
  #     @$el.append(@html)
  #     this
  #   # 显示图层
